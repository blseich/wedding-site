...
import { faCamera, faChildReaching, faEnvelope, faShirt, faUserTie } from '@fortawesome/free-solid-svg-icons';
    ...
    <div css={css`display: flex; flex-direction: column; justify-content: center; height: 100%; padding: 0 1rem;`}>
      ...
      <div css={css`flex-grow: 1; display: flex; flex-direction: column; justify-content: space-evenly;`}>
        ...
        <div>
          ...
          <div css={css`text-align: right;`}>We know. We&apos;ve seen your socials. You&apos;re wiz with the phone. But, during our ceremony, we encourage you to be present in the moment. <span css={css`font-weight: 700; text-align: center;`}>Please no photos or recording during the ceremony.</span> After that... Snap away! Capture and post all your moments, you little influencer you.</div>
        </div>
        <div>
