...
const Venue = () => {
  ...
  return (
    <div css={css`display: flex; flex-direction: column; justify-content: center; height: 100%; padding: 3rem 1rem 0;`}>
      <div css={css`font-size: 3rem; ${headerFont} letter-spacing: .5rem;`}>Travel</div>
      <div css={css`flex-grow: 1; display: flex; flex-direction: column; justify-content: space-evenly; ${textFont}`}>
        ...
        <div css={css`display: flex; flex-direction: column;`}>
          <div css={css`display: flex; justify-content: end; align-items: end; font-size: 2rem; ${subHeaderFont}`}>Hotel Block <FontAwesomeIcon icon={faHotel} css={css`font-size: 3rem; color: #13273f; margin-left: 1rem;`}/></div>
        ...
        <div css={css`text-align: left;`}>
          <div css={css`display: flex; align-items: end; font-size: 2rem; ${subHeaderFont}`}><FontAwesomeIcon icon={faStar} css={css`font-size: 3rem; color: #13273f; margin-right: 1rem;`}/> Entertainment</div>
