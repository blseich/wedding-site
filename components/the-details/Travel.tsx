    ...
    <div css={css`display: flex; flex-direction: column; justify-content: center; height: 100%;`}>
      ...
      <div css={css`flex-grow: 1; display: flex; flex-direction: column; justify-content: space-evenly;`}>
        ...
        <div css={css`display: flex; flex-direction: column;`}>
          <div css={css`text-align: center; font-size: 2rem; font-family: ${subHeaderFont.style.fontFamily};`}>Hotel Block</div>
            <a href="https://www.marriott.com/events/start.mi?id=1668548116381&key=GRP"><FontAwesomeIcon icon={faHotel} css={css`font-size: 3rem; color: #13273f;`}/></a>
            <div css={css`text-align: center;`}><a href="https://www.marriott.com/events/start.mi?id=1668548116381&key=GRP">Courtyard by Marriott Columbus, OH</a><br/>Book by April 13 to secure our group rate
          </div>
        </div>
        <div>
          <div css={css`text-align: center; font-size: 2rem; font-family: ${subHeaderFont.style.fontFamily};`}>Entertainment</div>
          Looking for something to do? Here are a few of our favorite spots in the area.
