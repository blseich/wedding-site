  ...
  return (
    <>
      ...
      <div css={css`height: 100%; width: 100%; color: #fffaf3; display: flex; flex-direction: column; align-items: center; justify-content: space-evenly;`}>
        <div css={css`${textFont} font-size: 1.25rem; margin: 1rem 0; padding: 0 1rem; text-align: center;`}>
        ...
        <div css={css`${headerFont} font-size: 3rem; letter-spacing: .5rem;`}>Thank You</div>
